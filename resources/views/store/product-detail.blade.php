		...
		<div class="breadcrumbs">
			<div class="container">
				<ol class="breadcrumb breadcrumb--ys pull-left">
					<li class="home-link"><a href="{{asset('blog_assets')}}/index.html" class="icon icon-home"></a></li>
				...
				<div class="container">
					<div class="row product-info-outer">
						<div id="productPrevNext" class="hidden-xs hidden-sm">
							<a href="#" class="product-prev"><img src="{{asset('blog_assets')}}/images/product/product-2.jpg" alt="" /></a>
							<a href="#" class="product-next"><img src="{{asset('blog_assets')}}/images/product/product-3.jpg" alt="" /></a>
						</div>
						<div class="col-sm-12 col-md-12 col-lg-12 col-xl-8">
							<div class="row">
								<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 hidden-xs">
									<div class="product-main-image">
										<div class="product-main-image__item"><img class="product-zoom" src='{{asset('blog_assets')}}/images/product/product-big-1.jpg' data-zoom-image="images/product/product-big-1-zoom.jpg" alt="" /></div>
										<div class="product-main-image__zoom"></div>
									</div>
									<div class="product-images-carousel">
										<ul id="smallGallery">
											<li><a href="#" data-image="images/product/product-big-1.jpg" data-zoom-image="images/product/product-big-1-zoom.jpg"><img src="{{asset('blog_assets')}}/images/product/product-small-1.jpg" alt="" /></a></li>
											<li><a href="#" data-image="images/product/product-big-2.jpg" data-zoom-image="images/product/product-big-2-zoom.jpg"><img src="{{asset('blog_assets')}}/images/product/product-small-2.jpg" alt="" /></a></li>
											<li><a href="#" data-image="images/product/product-big-3.jpg" data-zoom-image="images/product/product-big-3-zoom.jpg"><img src="{{asset('blog_assets')}}/images/product/product-small-3.jpg" alt="" /></a></li>
											<li><a href="#" data-image="images/product/product-big-4.jpg" data-zoom-image="images/product/product-big-4-zoom.jpg"><img src="{{asset('blog_assets')}}/images/product/product-small-4.jpg" alt="" /></a></li>
											<li><a href="#" data-image="images/product/product-big-5.jpg" data-zoom-image="images/product/product-big-5-zoom.jpg"><img src="{{asset('blog_assets')}}/images/product/product-small-5.jpg" alt="" /></a></li>
										</ul>
									</div>
									<a href="{{asset('blog_assets')}}/http://www.youtube.com/watch?v=0O2aH4XLbto" class="video-link"><span class="icon icon-videocam"></span>Video</a>
								</div>
						...
						<div class="custom-product-block col-xl-4 visible-xl">
							...
							<div class="vertical-carousel vertical-carousel-2 with-checkbox offset-top-40">
								<div class="vertical-carousel__item">
									...
									<div class="vertical-carousel__item__image pull-left"><a href="#"><img src="{{asset('blog_assets')}}/images/product/product-80x100-3.jpg" alt=""></a></div>
								...
								<div class="vertical-carousel__item">
									...
									<div class="vertical-carousel__item__image pull-left"><a href="#"><img src="{{asset('blog_assets')}}/images/product/product-80x100-4.jpg" alt=""></a></div>
									<div class="vertical-carousel__item__title">
										<h2><a href="#">Quis nostrud exercit ation</a></h2>
									</div>
									<div class="price-box">$26.00<span class="price-box__old">$28.00</span></div>
								...
								<div class="vertical-carousel__item">
									...
									<div class="vertical-carousel__item__image pull-left"><a href="#"><img src="{{asset('blog_assets')}}/images/product/product-80x100-1.jpg" alt=""></a></div>
									<div class="vertical-carousel__item__title">
										<h2><a href="#">Quis nostrud exercit ation</a></h2>
									</div>
									<div class="price-box">$26.00<span class="price-box__old">$28.00</span></div>
								...
								<div class="vertical-carousel__item">
									...
									<div class="vertical-carousel__item__image pull-left"><a href="#"><img src="{{asset('blog_assets')}}/images/product/product-80x100-2.jpg" alt=""></a></div>
									<div class="vertical-carousel__item__title">
										<h2><a href="#">Quis nostrud exercit ation</a></h2>
									</div>
									<div class="price-box">$26.00<span class="price-box__old">$28.00</span></div>
							...
							<div class="product">
								<div class="product__inside">
									...
									<div class="product__inside__image">
										<a href="#"> <img src="{{asset('blog_assets')}}/images/product/product-13.jpg" alt=""> </a> 
										<!-- quick-view --> 
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="#"> <img src="{{asset('blog_assets')}}/images/product/product-14.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
									...
									<div class="product__inside__hover">
										...
										<div class="product__inside__info">
											<ul class="options-swatch options-swatch--color">
												<li><a href="#"><span class="swatch-label"><img src="{{asset('blog_assets')}}/images/colors/blue.png"  alt=""/></span></a></li>
												<li><a href="#"><span class="swatch-label"><img src="{{asset('blog_assets')}}/images/colors/yellow.png"  alt=""/></span></a></li>
												<li><a href="#"><span class="swatch-label"><img src="{{asset('blog_assets')}}/images/colors/red.png"  alt=""/></span></a></li>
											</ul>
											<div class="product__inside__info__btns"> <a href="#" class="btn btn--ys btn--xl"><span class="icon icon-shopping_basket"></span> Add to cart</a>
												<a href="#" class="btn btn--ys btn--xl visible-xs"><span class="icon icon-favorite_border"></span></a>
												<a href="#" class="btn btn--ys btn--xl visible-xs"><span class="icon icon-sort"></span></a>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="#"> <img src="{{asset('blog_assets')}}/images/product/product-15.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="#"> <img src="{{asset('blog_assets')}}/images/product/product-16.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product sold-out">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="#"> <img src="{{asset('blog_assets')}}/images/product/product-17.jpg" alt=""> </a> 
										<!-- label sold-out -->
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="#"> <img src="{{asset('blog_assets')}}/images/product/product-18.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="#"> <img src="{{asset('blog_assets')}}/images/product/product-6.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
...
@section('footer')
		<script src="{{asset('blog_assets')}}/js/js-product.js"></script>		
	{{-- <script src="{{ asset('../blog_assets/js/js-product.js')}}"></script>	 --}}
@endsection
