...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="{{asset('blog_assets')}}/favicon.ico">
		<!-- Mobile Specific Metas -->
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<!-- External Plugins CSS -->
		<link rel="stylesheet" href="{{asset('blog_assets')}}/external/slick/slick.css">
		<link rel="stylesheet" href="{{asset('blog_assets')}}/external/slick/slick-theme.css">
		<link rel="stylesheet" href="{{asset('blog_assets')}}/external/magnific-popup/magnific-popup.css">
		<link rel="stylesheet" href="{{asset('blog_assets')}}/external/bootstrap-select/bootstrap-select.css">		
		<!-- Custom CSS -->
		<link rel="stylesheet" href="{{asset('blog_assets')}}/css/style.css">
		<!-- Icon Fonts  -->
		<link rel="stylesheet" href="{{asset('blog_assets')}}/font/style.css">
		<!-- Head Libs -->
		<!-- Modernizr -->
		<script src="{{asset('blog_assets')}}/external/modernizr/modernizr.js"></script>
	...
	<body>
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							<li class="col-one-fourth">
								...
								<a href="listing.html">
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/listing-img-1.png') }}" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/listing-img-2.png') }}" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/listing-img-3.png') }}" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/listing-img-4.png') }}" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/listing-img-5.png') }}" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/listing-img-6.png') }}" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/listing-img-7.pn') }}g" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="{{ asset('../blog_assets/images/custom/listing-img-8.png') }}" alt=""/></span>
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/product-menu-img-1.png') }}" alt=""/></span>
							...
							<li class="col-one-third">
								<span class="image-link">
								<a href="product.html">
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/product-menu-img-2.png') }}" alt=""/></span>
							...
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/product-menu-img-3.png') }}" alt=""/></span>
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/blog-menu-img-1.png') }}" alt=""/></span>
							...
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/blog-menu-img-2.png') }}" alt=""/></span>
							...
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/blog-menu-img-3.png') }}" alt=""/></span>
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/gallery-menu-img-1.png') }}" alt=""/></span>
							...
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/gallery-menu-img-2.png') }}" alt=""/></span>
							...
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/gallery-menu-img-3.png') }}" alt=""/></span>
							...
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/gallery-menu-img-4.png') }}" alt=""/></span>
							...
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="{{ asset('../blog_assets/images/custom/gallery-menu-img-5.png') }}" alt=""/></span>
							...
							<div class="account link-inline  hidden mobile-menu-on">
								<div class="dropdown text-right">
									...
									<ul class="dropdown-menu dropdown-menu--xs-full">
										...
										<li><a href="login_form.html"><span class="icon icon-lock"></span>Log In</a></li>
				...
				<div class="container offset-top-5">
					<div class="row">
						...
						<div class="col-xs-12 col-md-3 col-lg-3 col-xl-3 col-sm-3">
							<!-- logo start --> 
							<a href="index.html"><img class="logo replace-2x img-responsive" src="{{ asset('../blog_assets/images/logo.png') }}" alt=""/></a> 
							<!-- logo end --> 
						</div>
						<!-- /col-left -->						
						<!-- col-right -->										
						<div class="col-sm-6 col-md-8 col-lg-8 col-xl-8 pull-right text-right">
							<div class="row-functional-link">								
									...
									<div class="dropdown text-right">
										...
										<div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
											<div class="container">
												...
												<ul>
													<li class="cart__item">
														<div class="cart__item__image pull-left"><a href="#"><img src="{{ asset('../blog_assets/images/product/product-1.jpg')}} " alt=""/></a></div>
													...
													<li class="cart__item">
														<div class="cart__item__image pull-left"><a href="#"><img src="{{ asset('../blog_assets/images/product/product-2.jpg')}}" alt=""/></a></div>
														<div class="cart__item__control">
															<div class="cart__item__delete"><a href="#" class="icon icon-delete"><span>Delete</span></a></div>
															<div class="cart__item__edit"><a href="#" class="icon icon-edit"><span>Edit</span></a></div>
														</div>
								...
								<!-- /Compare end -->
								<!-- Wishlist start -->
								<div class="cart link-inline  mobile-menu-off"  onclick="location.href='wishlist.html'">
									<div class="dropdown">
										<a class="dropdown-toggle" data-toggle="dropdown">
											<span class="badge badge--cart">0</span>
								...
								<div class="h-address pull-right hidden-md hidden-sm hidden-xs">
									 <span class="icon icon-call"></span> <b>0973653820</b> <br>
									 <span class="icon icon-call"></span><b >0974231270</b> <br>
									 Mon-Sun: 00:00am-24:00pm
								</div>
								<!-- /address -->										
							</div>
						</div>					
											...
											<li class="dropdown dropdown-mega-menu">											
												...
												<ul class="dropdown-menu megamenu image-links-layout" role="menu">												
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index.html">
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-1.jpg') }} " alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-2.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-3.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-4.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-5.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-6.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-7.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-8.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-9.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-10.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-11.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
													...
													<li class="col-one-fourth">
														...
														<span class="figure"><img class="img-responsive img-border" src=" {{ asset('../blog_assets/images/custom//layout-img-12.jpg') }}" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
											...
											<li class="dropdown dropdown-mega-menu">
												...
												<ul class="dropdown-menu megamenu image-links" role="menu">
													...
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="listing-without-col-without-static-block_small_07.html">
														<span class="figure"><img class="img-responsive" src=" {{ asset('../blog_assets/images/custom//listing-img-7.png') }}" alt=""/></span>
														<span class="figcaption text-uppercase">Small</span>
														</a>
														</span>
													</li>
											...
											<li class="dropdown dropdown-mega-menu">
												...
												<ul class="dropdown-menu megamenu" role="menu">
																	...
																	<div class="product">
																		<div class="product__inside">
																			...
																			<div class="product__inside__image">
																				<a href="product.html"> <img src="{{ asset('../blog_assets/images/product/product-20.jpg') }}" alt=""> </a> 																	
																			</div>
																			<!-- /product image --> 
																			<!-- product name -->
																...
																<div>
																	...
																	<div class="product">
																		<div class="product__inside">
																			<!-- product image -->
																			<div class="product__inside__image">
																				<a href="product.html"> <img src="{{ asset('../blog_assets/images/product/product-4.jpg') }}" alt=""> </a>
													...
													<li class="col-sm-12 hidden-xs">
														<div class="row">
															<div class="col-sm-6"> <a href="#" class="discolor-hover"><img class="img-responsive" src=" {{ asset('../blog_assets/images/custom//banner-megamenu-01.jpg') }}" alt=""/></a> </div>
															<div class="col-sm-6"> <a href="#" class="discolor-hover"><img class="img-responsive" src=" {{ asset('../blog_assets/images/custom//banner-megamenu-02.jpg') }}" alt=""/></a> </div>
														</div>
													</li>
												</ul>
											</li>
												...
												<ul class="dropdown-menu megamenu" role="menu">
													...
													<li class="col-sm-3">												
														<a href="listing.html" class="megamenu__subtitle">
															<span>TOPS</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src=" {{ asset('../blog_assets/images/custom//mens-category-1.jpg') }}" alt=""/></span>
														</a>
													...
													<li class="col-sm-3">
														<a href="listing.html" class="megamenu__subtitle">
															<span>BOTTOMS</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src=" {{ asset('../blog_assets/images/custom//mens-category-2.jpg') }}" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing.html">Trousers</a></li>
													...
													<li class="col-sm-3">
														<a href="#" class="megamenu__subtitle">
															<span>ACCESSORIES</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src=" {{ asset('../blog_assets/images/custom//mens-category-3.jpg') }}" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing.html">Bags</a></li>
													...
													<li class="col-sm-3 hidden-xs">
														...
														<div class="vertical-carousel vertical-carousel-1 special-carousel">
															<div class="vertical-carousel__item">
																<div class="vertical-carousel__item__image pull-left"><a href="product.html"><img src="{{ asset('../blog_assets/images/product/product-120x150-1.jpg') }}" alt=""></a></div>
															...
															<div class="vertical-carousel__item">
																<div class="vertical-carousel__item__image pull-left"><a href="product.html"><img src="{{ asset('../blog_assets/images/product/product-120x150-2.jpg') }}" alt=""></a></div>
																<div class="product__label product__label--sale"> <span>Sale</span></div>
																<div class="vertical-carousel__item__title">
													...
													<li class="col-sm-12 hidden-xs">
														...
														<ul class="list-inline brands-list">
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-01.png') }}" alt=""></a></li>
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-03.png') }}" alt=""></a></li>
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-02.png') }}" alt=""></a></li>
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-05.png') }}" alt=""></a></li>
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-04.png') }}" alt=""></a></li>
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-06.png') }}" alt=""></a></li>
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-07.png') }}" alt=""></a></li>
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-08.png') }}" alt=""></a></li>
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-09.png') }}" alt=""></a></li>
															<li><a href="#"><img src=" {{ asset('../blog_assets/images/custom//brand-10.png') }}" alt=""></a></li>
														</ul>
													</li>
												</ul>
											</li>
				...
				<div class="row" >
					<div class="col-xl-3 visible-xl">
						<div class="footer-logo hidden-xs">
							<!--  Logo  --> 
							<a class="logo" href="index.html"> <img class="replace-2x" src="{{ asset('../blog_assets/images/logo.png') }}" alt="YOURStore"> </a> 
							<!-- /Logo --> 
						</div>
						<div class="box-about">
			...
			<div class="container">
				...
				<div class="compared-product-row">
					<div class="compared-product">
						...
						<div class="compared-product__image"><a href="#"><img src="{{ asset('../blog_assets/images/product/product-1.jpg') }}" alt=""/></a></div>
      ...
      <!-- Modal (quickViewModal) -->		
						...
						<div class="row product-info-outer">
							<div class="col-xs-12 col-sm-5 col-md-6 col-lg-6">
								<div class="product-main-image">
									<div class="product-main-image__item"><img src='{{ asset('../blog_assets/images/product/product-big-1.jpg')}} ' alt="" /></div>
								</div>
							</div>
							<div class="product-info col-xs-12 col-sm-7 col-md-6 col-lg-6">
								...
								<div class="product-info__description">
									<div class="product-info__description__brand"><img src=" {{ asset('../blog_assets/images/custom//brand.png') }}" alt=""> </div>
								...
								<ul class="options-swatch options-swatch--color options-swatch--lg">
									<li><a href="#"><span class="swatch-label"><img src="{{ asset('../blog_assets/images/colors/oldlace.png') }}" alt=""/></span></a></li>
									<li><a href="#"><span class="swatch-label"><img src="{{ asset('../blog_assets/images/colors/dark-grey.png') }}" alt=""/></span></a></li>
									<li><a href="#"><span class="swatch-label"><img src="{{ asset('../blog_assets/images/colors/grey.png') }}" alt=""/></span></a></li>
									<li><a href="#"><span class="swatch-label"><img src="{{ asset('../blog_assets/images/colors/light-grey.png') }}" alt=""/></span></a></li>
								</ul>						
								<div class="wrapper">
		  ...
		  <div class="modal-dialog white-modal">
		    <div class="modal-content modal-md">
		      <div class="modal-bg-image bottom-right"> 
			      <img  src=" {{ asset('../blog_assets/images/custom//newsletter-bg.png') }}" alt="" class="img-responsive"> 
			  </div>
		      <div class="modal-block">
			      ...
			      <div class="modal-newsletter text-center">
			      	    <img class="logo replace-2x img-responsive1" src="{{ asset('../blog_assets/images/logo.png') }}" alt=""/>
		...
		<script src="{{asset('blog_assets')}}/external/jquery/jquery-2.1.4.min.js"></script> 
		<!-- Bootstrap 3--> 
		<script src="{{asset('blog_assets')}}/external/bootstrap/bootstrap.min.js"></script> 
		<!-- Specific Page External Plugins --> 
		<script src="{{asset('blog_assets')}}/external/slick/slick.min.js"></script> 
		<script src="{{asset('blog_assets')}}/external/bootstrap-select/bootstrap-select.min.js"></script> 
		<script src="{{asset('blog_assets')}}/external/countdown/jquery.plugin.min.js"></script> 
		<script src="{{asset('blog_assets')}}/external/countdown/jquery.countdown.min.js"></script> 		
		<script src="{{asset('blog_assets')}}/external/instafeed/instafeed.min.js"></script> 
		<script src="{{asset('blog_assets')}}/external/magnific-popup/jquery.magnific-popup.min.js"></script> 
		<script src="{{asset('blog_assets')}}/external/nouislider/nouislider.min.js"></script>
		<script src="{{asset('blog_assets')}}/external/imagesloaded/imagesloaded.pkgd.min.js"></script> 
		<script src="{{asset('blog_assets')}}/external/elevatezoom/jquery.elevatezoom.js"></script>
		<script src="{{asset('blog_assets')}}/external/colorbox/jquery.colorbox-min.js"></script> 
		<!-- Custom --> 
